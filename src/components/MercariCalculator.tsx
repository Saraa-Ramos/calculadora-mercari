...
export default function MercariCalculator() {
  ...
  function handleSendCompleto(payment: { name: string; icon: string; amount: number; currency: string }) {
    if (!results) return
    const precio = payment.currency === 'Bs'
                  ...
                  {!showWaOptions ? (
                    ...
                    <div className={styles.waOptions}>
                      ...
                      <div className={styles.waButtons}>
                        <button className={styles.waOptionBtn} onClick={handleSendWhatsApp}>
                          Individual
                        </button>
                    ...
                    <div className={styles.waOptions}>
                      ...
                      <div className={styles.waButtons}>
                        ...
                        <button className={styles.waOptionBtn} onClick={() => handleSendCompleto({ name: 'Binance Pay', icon: '₿', amount: results!.totalUsd, currency: 'USD'  })}>₿ Binance</button>
                        <button className={styles.waOptionBtn} onClick={() => handleSendCompleto({ name: 'BCV',         icon: '💵', amount: results!.totalBs,  currency: 'Bs'   })}>💵 BCV</button>
                      </div>
